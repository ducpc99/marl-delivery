...
#from greedyagent import GreedyAgents as Agents   # Uncomment nếu muốn so sánh greedy
from acoagent import ACOAgents as Agents         # ACOAgents là phiên bản mới bạn vừa nhận
